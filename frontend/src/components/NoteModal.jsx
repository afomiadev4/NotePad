          ...
          {!isEditing ? (
            <div className="max-w-3xl animate-in fade-in slide-in-from-bottom-4 duration-500">
              ...
              <div
                ...
                dangerouslySetInnerHTML={{ __html: formData.content || "<p className='italic text-white/20'>No content...</p>" }}
              />
            </div>
          ) : (
        ...
        <aside className="w-full lg:w-80 flex flex-col px-6 py-8 border-t lg:border-t-0 lg:border-l border-white/10 bg-zinc-900/50 justify-between">
          <div className="flex flex-col gap-8">
            ...
            <div className="space-y-2">
              <label className="text-[10px] font-black uppercase tracking-widest text-white/30 ml-1">Mode</label>
              <button
                type="button"
              ...
              >
                {isEditing ? (
                  ...
                  <><i className="fa-solid fa-pen-to-square text-blue-400"></i> Edit Note</>
                )}
              </button>
            </div>
            ...
            {isEditing && (
              <div className="space-y-6 animate-in slide-in-from-right-4">
                ...
                <div className="flex flex-col gap-2">
                  <label className="text-[10px] font-black uppercase tracking-widest text-white/30 ml-1">Folder</label>
                  <select
          ...
          <div className="flex flex-col gap-3 mt-8">
            {isEditing ? (
              <button type="submit" className="w-full py-4 rounded-xl bg-blue-600 hover:bg-blue-500 font-black text-[10px] uppercase tracking-widest transition shadow-lg shadow-blue-600/20">
                Save Changes
              </button>
            ) : (
              <button type="button" onClick={onDelete} className="w-full py-4 rounded-xl bg-red-500/10 text-red-500 border border-red-500/20 font-black text-[10px] uppercase tracking-widest hover:bg-red-500 hover:text-white transition">
                Delete Note
              </button>
            )}
